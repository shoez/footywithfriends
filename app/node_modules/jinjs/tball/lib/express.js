  ...
  ExpressEnvironment = (function(_super){
    ...
    prototype.trackFile = (function(){
      function trackFile(path){
        if (this.track_changes) {
          return ExpressEnvironment.superclass.prototype.trackFile.call.call(this, this, path);
        }
      }
      return trackFile;
    }());
    prototype.getTemplateFromString = (function(){
      function getTemplateFromString(str, ctx){
        ...
        res = ExpressEnvironment.superclass.prototype.getTemplateFromString.call.call(this, this, str, ctx);
